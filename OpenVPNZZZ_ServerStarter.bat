...
java -cp OpenVPNZZZ_V20201005.jar use.openvpn.serverui.ServerMainUIZZZ -d . -f ZKernelConfig_OVPNServer.ini > c:\fglkernel\kernellog\OpenVPNZZZ_ServerStarterLog.txt
pause