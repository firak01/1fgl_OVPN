...
java -cp OpenVPNZZZ_V20200701.jar use.openvpn.clientui.ClientMainUIZZZ -d . -f ZKernelConfig_OVPNClient.ini > c:\fglkernel\kernellog\OpenVPNZZZ_ClientStarterLog.txt
pause